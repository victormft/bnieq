 ...
 */
class TbToggle2Column extends TbDataColumn
{
	...
	protected function initButton()
	{
		...
		$this->button = array(
			'url' => 'Yii::app()->controller->createUrl("' . $this->toggleAction . '",array("user_id"=>$data->primaryKey["user_id"], "startup_id"=>$data->primaryKey["startup_id"],"attribute"=>"' . $this->name . '"))',
