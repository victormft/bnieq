 ...
 */
class TbToggle2Action extends CAction
{
	/**
	 ...
	 */
	public function run($user_id, $startup_id, $attribute)
	{
		if (Yii::app()->getRequest()->isPostRequest) {
			$model = $this->loadModel($user_id, $startup_id);
	 ...
	 */
	protected function loadModel($uid, $sid)
	{
		$model = UserStartup::model()->findByAttributes(array('user_id'=>$uid, 'startup_id'=>$sid));
