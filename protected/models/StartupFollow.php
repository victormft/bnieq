...
/**
 * This is the model class for table "startup_follow".
 *
 * The followings are the available columns in table 'startup_follow':
 * @property string $user_id
 * @property string $startup_id
 */
class StartupFollow extends CActiveRecord
{
	/**
	 ...
	 * @return StartupFollow the static model class
	 */
